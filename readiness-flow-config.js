...
export const PROFILE_QUESTIONS = [
  ...
  },
  {
    ...
    options: [
      ...
      { value: "HABE", label: "Historically Underutilized Business (HABE)" },
    ],
    note:
  ...
  },
  {
    ...
    prompt: "Is the qualifying owner a Native American (enrolled tribal member)?",
    type: "single_select",
    options: [
      { value: "yes", label: "Yes" },
      { value: "no", label: "No" },
  ...
  },
  {
    ...
    prompt: "Does your work require a professional or trade license (e.g. contractor, cosmetology, etc.)?",
    type: "single_select",
    options: [
      { value: "yes", label: "Yes" },
...
export const DOCUMENT_GROUPS = [
    ...
    items: [
      {
        ...
        guidance: "Just one or the other is needed, not both.",
      },
      {
      ...
      {
        label: "Professional/Trade License (if applicable)",
        guidance: "Upload any license tied to the work you do. If you're a consulting-type business, this typically doesn't apply.",
      },
      {
  ...
  },
  {
    ...
    items: [
      ...
      {
        label: "Tribal documentation (if Native American)",
        guidance: "Only applies if the qualifying owner is an enrolled Native American tribal member.",
      },
    ],
  },
  {
...
export const RENEWAL_GUIDANCE = {
  message:
    "For a renewal, you don't need to go through the full document walkthrough again. You'll submit a renewal application (available on the Supply SA website) along with the required documents listed on page 3 of that renewal application. Business Enterprise Program (SMWVBE) renewals happen every 2 years. Disadvantaged Business Enterprise (DBE) certification doesn't expire, but you need to submit an Annual Update Affidavit with supporting documents every year — missing that can start the decertification process. Your renewal window opens within 6 months of your expiration date.",
};
